...
_printf is a custom recreation of the C standard library function, `printf`.
...
* Programs and functions will be compiled with `gcc` using flags
...
int main(void)
{
        char *sch = "St. Joseph Sch", *city = "Tokyo", *state = "Nigeria";

        _printf("%s %d, %s, %s %d\n", sch 2, city, state, 101225);
}
```
Output:
```
St. Joseph Sch 2, Tokyo, Nigeria, 101225
```
...
* Dighomanor Jeremiah <[Digho007](https://github.com/Digho007)>
* Akobi Mutiat <[PhoenixClix](https://github.com/PhoenixClix)>
